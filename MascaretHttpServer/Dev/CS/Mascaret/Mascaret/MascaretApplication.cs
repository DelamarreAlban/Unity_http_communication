    ...
    public class MascaretApplication
    {
        ...
        public virtual void parse(string applicationFileName, string baseDir, bool loadAll)
        {
           ...
           // logfile.WriteLine("Loading application file : " + BaseDir + "/" + applicationFileName); logfile.Flush();
            ...
            MascaretApplication.Instance.VRComponentFactory.Log(BaseDir + "/" + applicationFileName + "    PARSE : " + s);
        ...
        public virtual void parse(XElement root, bool loadAll)
        {
...

            {
                if (agentPlateform == null)
                {
                    ...
                    agentPlateform = new AgentPlateform("localhost", 8081, ressourceDir, false);
        ...
        Environment parseEnvironment(string url, XElement actNode, XElement orgNode, bool loadAll)
        {
         ...
         //   logfile.WriteLine("Parsing Environment file : " + url); logfile.Flush();
            ...
            MascaretApplication.Instance.VRComponentFactory.Log(BaseDir + "/" + url + "    PARSE ENV : " + s);
        ...
        public bool step()
        {
            ...
            //((HttpCommunicationManager)(agentPlateform.CommunicationManager[0])).httpServer.Update();
